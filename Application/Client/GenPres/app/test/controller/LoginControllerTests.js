Ext.define('GenPres.test.controller.LoginControllerTests', {
    ...
    tests: function () {
        ...
        it('Controller validateLogin does not validate when no username and password is chosen', function () {
            var controller = GenPres.application.getController("GenPres.controller.user.LoginController");
            GenPres.session.PatientSession.setLogicalUnit(1, "test");
        ...
        it('Controller validateLogin does not validate when no password is chosen', function () {
            var controller = GenPres.application.getController("GenPres.controller.user.LoginController");
            GenPres.session.PatientSession.setLogicalUnit(1, "test");
        ...
        it('Controller validateLogin does not validate when no username is chosen', function () {
            var controller = GenPres.application.getController("GenPres.controller.user.LoginController");
            GenPres.session.PatientSession.setLogicalUnit(1, "test");
        ...
        it('Controller validateLogin does not validate when no logicalUnit is chosen', function () {
            var controller = GenPres.application.getController("GenPres.controller.user.LoginController");
